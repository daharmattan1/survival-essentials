...
|----------|------|------|--------|--------|------------------|-----------------|---------------------|--------------------|-------------|--------------|---------------|
| potato | entries/potato.md | CROP | mid-atlantic-appalachian | plant Apr, harvest Jul–Sep | edible-when-prepared | low | none | false | T1 | 3 | reviewed |
| beans-dry | entries/beans-dry.md | CROP | mid-atlantic-appalachian | plant May, harvest Aug–Sep | edible-when-prepared | moderate | none | false | T1 | 4 | reviewed |
| winter-squash | entries/winter-squash.md | CROP | mid-atlantic-appalachian | plant May–Jun, harvest Sep–Oct | edible-when-prepared | low | none | false | T1 | 3 | reviewed |
| kale-collards | entries/kale-collards.md | CROP | mid-atlantic-appalachian | plant Apr & Aug, harvest into winter | edible-raw | none | none | false | T1 | 3 | reviewed |
| corn-flint | entries/corn-flint.md | CROP | mid-atlantic-appalachian | plant May, harvest Sep–Oct | edible-when-prepared | low | none | false | T1 | 4 | reviewed |
